        ...
        <div className="relative flex items-center justify-between">
          ...
          <ul class="flex items-center hidden space-x-8 lg:flex">
            <li>
              <a
                href="/"
                class="inline-flex items-center justify-center h-12 px-6 font-medium tracking-wide text-green transition duration-200 rounded shadow-md bg-white hover:bg-green hover:text-white border-2 focus:shadow-outline focus:outline-none"
                aria-label="Log in"
                title="Log in"
              >
                Log in
            ...
            <li>
              <a
                href="/"
                class="inline-flex items-center justify-center h-12 px-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-green hover:bg-green hover:bg-greenShade focus:shadow-outline focus:outline-none"
                aria-label="Sign up"
                title="Sign up"
              >
                Sign up
