       ...
       <div className="relative bg-gray-100">
        ...
        <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-72">
          <div className="relative max-w-2xl sm:mx-auto sm:max-w-xl md:max-w-2xl sm:text-center">
            ...
            This covers the guidelines and expectations regarding user behavior, responsibilities, and acceptable conduct while interacting with the product or service.
            </p>
            <a
              href="#faqs"
