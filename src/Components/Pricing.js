          ...
          {/* <div className="dark h-full">
            <div className="relative flex flex-col h-full p-6 rounded-2xl bg-white dark:bg-gray-100 border border-slate-200 dark:border-gray-100 shadow-lg shadow-slate-950/5">
              <div className="absolute top-0 right-0 mr-6 -mt-4">
                <div className="inline-flex items-center text-xs font-semibold py-1.5 px-3 bg-yellow text-white rounded-full shadow-sm shadow-slate-950/5">
                  Popular
                </div>
              </div>
              <div className="mb-5">
